...
from core.views import (
    ...
    dashboard_reminders_settings_api,
    dashboard_reminders_settings_save_api,
    dashboard_reminders_restore_dismissed_api,
    dashboard_trend_api,
    admin_promo_codes_page,
    admin_promo_redemptions_api,
    admin_promos_create_api,
    admin_promos_list_api,
    billing_init_payment_api,
    billing_paywall,
    billing_result,
    billing_tbank_notification,
    billing_promo_apply_free_days_api,
    billing_promo_preview_api,
    dashboard_home,
    home,
    ...
    price_robot_report,
    price_robot_run_api,
    price_robot_apply_api,
    pricing_page,
    promo_landing,
    register_trial,
    signup_confirm,
    sync_orders_start_api,
    sync_ads_full_start_api,
...
urlpatterns = [
    path('admin/promocodes/', admin_promo_codes_page, name='admin_promo_codes'),
    ...
    path('legal/consent/', legal_consent, name='legal_consent'),
    ...
    path('billing/result/', billing_result, name='billing_result'),
    path('billing/tbank/notification/', billing_tbank_notification, name='billing_tbank_notification'),
    path('api/billing/init-payment/', billing_init_payment_api, name='billing_init_payment_api'),
    path('api/billing/promo/preview/', billing_promo_preview_api, name='billing_promo_preview_api'),
    path('api/billing/promo/apply-free-days/', billing_promo_apply_free_days_api, name='billing_promo_apply_free_days_api'),
    path('api/admin/promos/', admin_promos_list_api, name='admin_promos_list_api'),
    path('api/admin/promos/create/', admin_promos_create_api, name='admin_promos_create_api'),
    path('api/admin/promos/<int:promo_id>/redemptions/', admin_promo_redemptions_api, name='admin_promo_redemptions_api'),
    path('logout/', auth_views.LogoutView.as_view(), name='logout'),
    path('account/settings/', account_settings, name='account_settings'),
    path('api/account/marketing-consent/', account_marketing_consent_api, name='account_marketing_consent_api'),
    path('api/sync/orders/start/', sync_orders_start_api, name='sync_orders_start_api'),
    path('api/sync/ads/full/start/', sync_ads_full_start_api, name='sync_ads_full_start_api'),
    ...
    path('price_robot/', price_robot_report, name='price_robot_report'),
    path('api/price_robot/run/', price_robot_run_api, name='price_robot_run_api'),
    path('api/price_robot/apply/', price_robot_apply_api, name='price_robot_apply_api'),
    ...
    path('api/product_cards/<int:product_id>/price/', product_price_update_api, name='product_price_update_api'),
    path(
    ...
    path('api/dashboard/reminders/settings/', dashboard_reminders_settings_api, name='dashboard_reminders_settings_api'),
    path('api/dashboard/reminders/settings/save/', dashboard_reminders_settings_save_api, name='dashboard_reminders_settings_save_api'),
    path(
        'api/dashboard/reminders/dismissed/restore/',
        dashboard_reminders_restore_dismissed_api,
        name='dashboard_reminders_restore_dismissed_api',
    ),
