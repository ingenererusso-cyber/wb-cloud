...
from core.views import (
    ...
    analytics_money_in_goods,
    analytics_paid_storage,
    analytics_paid_storage_data_api,
    create_feedback_api,
    dashboard_supply_recommendations_api,
    dashboard_summary_api,
    dashboard_orders_feed_api,
    dashboard_reminders_api,
    dashboard_trend_api,
...
urlpatterns = [
    ...
    path('api/product_glues/', product_glues_api, name='product_glues_api'),
    ...
    path('api/replenishment-report/', replenishment_report_api, name='replenishment_report_api'),
    ...
    path('api/dashboard/orders-feed/', dashboard_orders_feed_api, name='dashboard_orders_feed_api'),
    path('api/dashboard/reminders/', dashboard_reminders_api, name='dashboard_reminders_api'),
    ...
    path('api/analytics/paid-storage/data/', analytics_paid_storage_data_api, name='analytics_paid_storage_data_api'),
    path('supply_recommendations/', supply_recommendations_report, name='supply_recommendations_report'),
    path('', dashboard_home, name='home'),
    path('analytics/logistics/', logistics_dashboard, name='logistics_dashboard'),
