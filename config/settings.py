...
# SECRET_KEY = 'django-insecure-14@^nf$ea+&@m4y!5w-5caq_gpu5bur559vgfol_dl&6t+m1*u'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv("DEBUG", "True") == "True"

ALLOWED_HOSTS = ["155.212.209.227", "127.0.0.1", "localhost", "vendra.ru", "www.vendra.ru"]
LOGIN_URL = "/login/"
LOGIN_REDIRECT_URL = "/"
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.subscription_access',
            ],
        },
    },
]
...
EMAIL_VALIDATE_CERTS = _env_bool("EMAIL_VALIDATE_CERTS", True)
...
if EMAIL_HOST and not EMAIL_VALIDATE_CERTS:
    EMAIL_BACKEND = "core.mail_backends.LenientSMTPEmailBackend"
